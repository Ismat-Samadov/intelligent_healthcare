...
const healthcareKnowledgeBase = {
  ...
  'mental health': 'Mental health is as important as physical health and affects how we think, feel, and act. It influences how we handle stress, relate to others, and make choices. Common disorders include depression, anxiety, bipolar disorder, and PTSD. Professional help is available and effective. Reach out to a healthcare provider if you're struggling.'
};
